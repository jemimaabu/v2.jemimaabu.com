...
$(document).ready(function() {
    ...
    var facts = [
        ...
        "I've been learning French on Duolingo for about 2 years and I finished the course once. (which means I can translate an entire paragraph written in French, provided it's at elementary level)",
        "My guilty pleasure is reading trashy fanfiction (not on Wattpad though, I do have standards)",
        "I've worked over 8 jobs in the past 3 years (ranging from furniture salesperson to yoga instructor)",
